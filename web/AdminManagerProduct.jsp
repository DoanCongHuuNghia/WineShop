...
<html>
    <head>
        ...
        <title>Sparkling Shop - Admin Manager Product</title>
    ...
    <body>
        ...
        <jsp:include page="Header.jsp"></jsp:include>
            ...
            <div class="crudproduct">
                <div class="button">
                    <a class="crud" href="Admin.jsp">Back</a>    
                    <a class="crud" href="loaddataadmincreate"><i class="fas fa-plus"></i> New Product</a> 
                </div>
                <div class="table-crud">
                    ...
                    <c:forEach items="${listP}" var="i">
                        <tr>
                            ...
                            <td>${i.orgin}</td>
                            <td>
                                <a class="" href="loaddataadminupdate?pid=${i.id}" class="ud"><i class="fas fa-pencil-alt"></i></a>
                                <a class="" href="admindeleteproduct?pid=${i.id}" onclick="return confirm('Are you sure to delete product!');" class="ud"><i class="fas fa-trash-alt"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                </table>
