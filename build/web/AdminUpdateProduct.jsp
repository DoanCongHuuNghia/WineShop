...
<html>
    <head>
        ...
        <title>Sparkling Shop - Admin Update Product</title>
        <%
    ...
    <body>
        <div>
            <div class="header">
                ...
                <div>
                    <form class="form" action="adminupdateproduct" method="POST">    
                        ...
                        <div class="div">
                            ...
                            <c:forEach items="${listS}" var="o">
                                <option ${detail.sellid == o.id ? "selected" : ""} value="${o.id}">${o.name}</option>
                            </c:forEach>   
                            </select>
                        </div>
                        <div class="div">
